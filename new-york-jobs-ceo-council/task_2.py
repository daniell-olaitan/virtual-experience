...
class Invoice:
    ...
    def view_comments(self):
        # expose a string representation of all the comments
        if not self.comments:
            return 'No comments available.'
        return '/n'.join(self.comments)
...
if __name__ == '__main__':
    ...
    print(invoice_total)
     ...
     # Adding comments
    invoice.add_comment("This invoice needs to be reviewed by the finance team.")
    invoice.add_comment("Client requested a discount for early payment.")
